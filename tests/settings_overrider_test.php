 ...
 * @covers     \tool_overrider\local\settings_overrider
 */
final class settings_overrider_test extends \basic_testcase {
    ...
    public function test_plugin_sections_loaded_into_forced_plugin_settings(): void {
        ...
        // Verify tool_overrider metadata is present.
        $this->assertArrayHasKey('tool_overrider', $this->cfg->forced_plugin_settings);
        $this->assertArrayHasKey('configfile', $this->cfg->forced_plugin_settings['tool_overrider']);
        $this->assertArrayHasKey('loader', $this->cfg->forced_plugin_settings['tool_overrider']);
        $this->assertStringContainsString('json_loader', $this->cfg->forced_plugin_settings['tool_overrider']['loader']);
    }
    ...
    public function test_plugin_loader_autodetection(): void {
        ...
        $this->assertTrue($this->cfg->forced_plugin_settings['tool_overrider']['test_loader_used']);
    }
    ...
    /**
     * Test settings_from returns void.
     */
