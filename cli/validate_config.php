...
use tool_overrider\local\config_formatter;
use tool_overrider\local\config_loader;
use tool_overrider\local\settings_overrider;
...
require_once($CFG->dirroot . '/admin/tool/overrider/classes/local/settings_overrider.php');
 ...
 * @return \tool_overrider\local\config_loader The loader instance
 * @throws Exception If loader cannot be found
 */
function get_loader_instance(string $filepath, array $customloaders): \tool_overrider\local\config_loader {
    $extension = pathinfo($filepath, PATHINFO_EXTENSION);
 ...
 */
function load_custom_loader(string $loaderfile, string $extension): \tool_overrider\local\config_loader {
    global $CFG;
    ...
    foreach ($newclasses as $classname) {
        ...
        if (isset($implements['tool_overrider\\local\\config_loader'])) {
 ...
 */
function load_plugin_loader(string $extension): \tool_overrider\local\config_loader {
    $loaderfile = __DIR__ . "/../classes/local/loaders/{$extension}_loader.php";
    $loaderclass = "tool_overrider\\local\\loaders\\{$extension}_loader";
